...
CE_averageInvestor <- output_vector[[1]]
...
output_table[1,] <- c("Average investor",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor1_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor1,", K-means sorting, ESG-restricted")

CE_investor1 <- output_vector[[1]]

output_table[2,] <- c("Investor 1",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor2_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor2,", K-means sorting, ESG-restricted")

CE_investor2 <- output_vector[[1]]

output_table[3,] <- c("Investor 2",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor3_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor3,", K-means sorting, ESG-restricted")

CE_investor3 <- output_vector[[1]]

output_table[4,] <- c("Investor 3",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor4_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor4,", K-means sorting, ESG-restricted")

CE_investor4 <- output_vector[[1]]

output_table[5,] <- c("Investor 4",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor5_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor5,", K-means sorting, ESG-restricted")

CE_investor5 <- output_vector[[1]]

output_table[6,] <- c("Investor 5",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])

load('kmeans_ESGRestricted_optimal_allocations_vfinal_investor6_v3.RData')
optimal_allocations_kmeans_ESGRestricted <- optimal_allocations

output_vector <- Generate_all_plots(optimal_allocations_kmeans_ESGRestricted,return_test_set_kmeans_investor6,", K-means sorting, ESG-restricted")

CE_investor6 <- output_vector[[1]]

output_table[7,] <- c("Investor 6",output_vector[[2]],
                      output_vector[[3]],output_vector[[4]])
...
CE_all <- cbind(CE_averageInvestor,CE_investor1,CE_investor2,
                CE_investor3,CE_investor4,CE_investor5,
                CE_investor6)
